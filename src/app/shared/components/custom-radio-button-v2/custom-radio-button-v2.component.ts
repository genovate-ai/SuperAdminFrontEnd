...
@Component({
  selector: 'app-custom-radio-button-v2',
  templateUrl: './custom-radio-button-v2.component.html',
  styleUrls: ['./custom-radio-button-v2.component.scss'],
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: CustomRadioButtonV2Component, multi: true }
  ]
})
export class CustomRadioButtonV2Component implements  OnInit,ControlValueAccessor  {
