...
import { ComponentFactoryResolver, HostListener, Renderer2, Type, ViewContainerRef } from '@angular/core';
...
export class ReportModalComponent implements OnInit {
  ...
  @ViewChild('popupcontainer', { read: ViewContainerRef, static: true }) container: ViewContainerRef;
