...
@Component({
  selector: 'app-custom-radio-button-v3',
  templateUrl: './custom-radio-button-v3.component.html',
  styleUrls: ['./custom-radio-button-v3.component.scss'],
  providers: [
    { provide: NG_VALUE_ACCESSOR, useExisting: CustomRadioButtonV3Component, multi: true }
  ]
})
export class CustomRadioButtonV3Component implements OnInit, ControlValueAccessor {
