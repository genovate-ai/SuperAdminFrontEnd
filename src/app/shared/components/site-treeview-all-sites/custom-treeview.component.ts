...
import { DefaultTreeviewEventParser, OrderDownlineTreeviewEventParser, TreeviewComponent, TreeviewConfig, TreeviewEventParser, TreeviewI18n, TreeviewI18nDefault, TreeviewItem } from 'ngx-treeview';
...
@Component({
  selector: 'app-custom-treeview-component',
...
export class CustomTreeviewComponent extends TreeviewComponent implements OnInit {
  disableSave = false;
