...
@Component({
  selector: 'app-hierarchy-select-box',
  templateUrl: './hierarchy-select-box.component.html',
  styleUrls: ['./hierarchy-select-box.component.scss'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => HierarchySelectBoxComponent),
      multi: true
    }
  ]
})
export class HierarchySelectBoxComponent implements OnInit {
